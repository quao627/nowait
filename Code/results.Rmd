...
reviews <- read_csv("/Users/aoqu/Desktop/NoWait_Research/PSM+DID/reviews(NMF).csv")
```
```{r}
...
print('Number of reviews(Treated): ')
print(NROW(df_regression_1[which(df_regression_1$Treated==1), ]))
print('Number of reviews(Control): ')
print(NROW(df_regression_1[which(df_regression_1$Treated==0), ]))
